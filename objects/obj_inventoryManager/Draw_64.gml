...
if(keyboard_check_direct(ord("I"))) {
	draw_sprite(sp_inventar_voll, -1, guiHolderPosX - 20 ,660 - 245);
	...
	guiHolderPosY + guiHolderPadd + 660 - 146 - (3-i) * (50), 38, 38);	
	
		draw_text(	(guiHolderPosX + guiHolderPadd) + (guiHolderSlotOffset * p),
	guiHolderPosY + guiHolderPadd + 30 + 660 - 146 - (3-i) * (50), string(global.itemDefinitions[itemDefIndex, ItemProperty.amount]));	
	}
	}
}
	...
	draw_sprite(sp_inventar_halter, -1, guiHolderPosX - 20 ,670 - 75);
}
...
for(var i = 0; i < MAX_ACTIVE_INV_ITEMS; i++) {
	...
	guiHolderPosY + guiHolderPadd + 660 - 78, 38, 38);	
	
		draw_text(	(guiHolderPosX + guiHolderPadd) + (guiHolderSlotOffset * i),
	guiHolderPosY + guiHolderPadd + 30 + 660 - 75, string(global.itemDefinitions[itemDefIndex, ItemProperty.amount]));	
