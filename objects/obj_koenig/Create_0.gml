...
lanzen = false;
anzahlLanzen = 13;
lanzenListe = ds_list_create();
laengeY = sprite_height;
laengeBreite = sprite_width;
...
lanzeObenRechts.image_angle = 135;
...
lanzeMitteRechts.image_angle = 90;
lanzeMitteLinks.direction = 180;
lanzeMitteLinks.image_angle = 270;
...
lanzeUntenRechts.image_angle = 45;
lanzeUntenLinks.direction = 225;
lanzeUntenLinks.image_angle = 315;
