...
ds_list_add(global.dialog, "Nun dann, ich werde dir helfen. Das erste was du brauchst ist das Juwel des Königs. Er stahl es mir vor Jahren und es ist die die Quelle für die stärkste Magie auf dieser Seite der schwarzen Berge.");
ds_list_add(global.dialog, "Verstehe. Aber wo finde ich diesen Juwel?");
ds_list_add(global.dialog, "Im Schloss. Du kannst über die Kanalisation dorthin kommen. Wenn du es hast, komm hier her zurück und ich gebe dir die nächste Aufgabe");
